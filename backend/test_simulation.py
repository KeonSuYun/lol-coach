...
# 提取 S15 机制 (来自 secure_data/s15_mechanics.json，简略版)
MOCK_S15_MECHANICS = {
    "data_modules": {
        "jungle_physics": {
            "items": [
                {"name": "速3路径学", "rule": "终点决定起点", "note": "⚠️ 核心决策逻辑：..."},
                {"name": "无帮开机制", "rule": "下路/上路不再帮打野开怪", "note": "S15 兵线机制..."},
...
def analyze_logic(data):
    ...
    s15_context = f"【S15/峡谷常识库】: {s15_details}"
    ...
    system_content = sys_tpl_str.replace("{s15_context}", full_s15_context_with_skills)
